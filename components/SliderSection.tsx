...
const SliderSection = () => {
    ...
    return (
        <>
            <Box mt={{ md: 3, sm: 2, xs: 0 }} gap={3} sx={{ p: { lg: 0, md: 2, sm: 2, xs: 0 } }}>
                <Slider {...settings} >
                    {cardContents.map((e, idx) => (
                        <Card
                            key={idx + 1}
                            sx={idx === imageIndex ? {
                                "transform": mobile ? "scale(0.8)" : tablet ? "scale(0.9)" : "scale(1)",
                                "transition": "transform 300ms",
                                borderRadius: 2,
                                height: { xs: 200, sm: 200, md: 280, lg: 240 },
                                width: "auto",
                                ...
                                {
                                    "transform": mobile ? "scale(0.7)" : tablet ? "scale(0.8)" : "scale(0.8)",
                                    "transition": "transform 300ms",
                                    borderRadius: 2,
                                    height: { xs: 200, sm: 200, md: 280, lg: 240 },
                                    width: "auto",
